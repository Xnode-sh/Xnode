...
Проект развивается в свободное время. Если инструменты пригодились —
поддержать можно в [Telegram-канале RED·TEAM·LAB (@xnode_sh)](https://t.me/xnode_sh)
(способ поддержки скоро появится там).

Нужен кастомный OSINT/red-team скрипт под задачу или консультация по
Termux-агентам — пишите в канал.
